...
-- CreateEnum
CREATE TYPE "PaymentType" AS ENUM ('CREDIT', 'DEBIT', 'MONEY');
...
CREATE TABLE "payments" (
    ...
    "split_payment" TEXT,
    "paymentType" "PaymentType" NOT NULL DEFAULT 'DEBIT',
    "payday" TIMESTAMP(3) NOT NULL,
    "updatedAt" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3),
    "userId" INTEGER NOT NULL,
    "officeIdentity" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "payments" ADD CONSTRAINT "payments_officeIdentity_fkey" FOREIGN KEY ("officeIdentity") REFERENCES "offices"("identity") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "users" ADD CONSTRAINT "users_officeId_fkey" FOREIGN KEY ("officeId") REFERENCES "offices"("identity") ON DELETE SET NULL ON UPDATE CASCADE;
